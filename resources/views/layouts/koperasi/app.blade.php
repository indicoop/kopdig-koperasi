...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg">
    ...
    <head>
        ...
        @include('layouts.koperasi.partials.style')
...
@include('layouts.koperasi.components.navbar')
            <!-- ========== App Menu ========== -->
@include('layouts.koperasi.components.sidebar
')
            <!-- Left Sidebar End -->
            <!-- Vertical Overlay-->
            ...
            <div class="main-content">
                ...
                <!-- End Page-content -->
@include('layouts.koperasi.components.footer')
            </div>
            <!-- end main content-->
        ...
        @include('layouts.koperasi.partials.script')
    </body>
